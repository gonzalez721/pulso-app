...
export async function updateProfile(req: AuthRequest, res: Response): Promise<void> {
  ...
  const updatedUser = await prisma.user.update({
    ...
    data: {
      ...
      ...(ingresoMensual !== undefined && ingresoMensual > 0 && { ingresoMensual: Number(ingresoMensual) }),
      ...(horasTrabajoSemanal !== undefined && horasTrabajoSemanal > 0 && { horasTrabajoSemanal: Number(horasTrabajoSemanal) }),
